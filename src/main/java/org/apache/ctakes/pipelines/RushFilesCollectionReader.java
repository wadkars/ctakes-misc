...
public class RushFilesCollectionReader extends JCasCollectionReader_ImplBase {

  public static CollectionReaderDescription getDescription(String fileOrDir)
      throws ResourceInitializationException {
    return CollectionReaderFactory.createReaderDescription(
        RushFilesCollectionReader.class,
        null,
        PARAM_ROOT_FILE,
        fileOrDir);
  }
  ...
  public void getNext(JCas jCas) throws IOException, CollectionException {
    ...
    */
    ...
    //Cloudera - This is the key line
    //String text2 = (String) this.getConfigParameterValue("FileContent");
    CTakesFilePart cTakesFilePart = (CTakesFilePart) this.getConfigParameterValue("ctakesFilePart");
    view.setSofaDataString(cTakesFilePart.getInput(), "text/plain");
    //System.err.println(cTakesFilePart.getInput());
    ...
    File f = new File("/tmp/");
    ViewUriUtil.setURI(jCas, f.toURI());
