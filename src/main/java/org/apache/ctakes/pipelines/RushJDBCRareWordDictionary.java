 ...
 * Date: 3/26/13
 */
final public class RushJDBCRareWordDictionary extends AbstractRareWordDictionary {
   ...
   public RushJDBCRareWordDictionary( final String name, final UimaContext uimaContext, final Properties properties )
         throws SQLException {
      this( name,
   ...
   public RushJDBCRareWordDictionary( final String name,
      ...
      try {
         ...
         connection = JdbcConnectionFactory.getInstance()
