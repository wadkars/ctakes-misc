...
import org.apache.ctakes.dictionary.lookup2.concept.*;
/**
 * @author SPF , chip-nlp
 * @version %I%
 * @since 9/23/2014
 */
 public class RushJdbcConceptFactory implements ConceptFactory {
   ...
   public RushJdbcConceptFactory( final String name, final UimaContext uimaContext, final Properties properties )
         throws SQLException {
	   /*
