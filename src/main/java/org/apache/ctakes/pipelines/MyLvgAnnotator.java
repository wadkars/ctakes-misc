...
public class MyLvgAnnotator extends JCasAnnotator_ImplBase {
  ...
  public static String copyLvgFiles(String absolutePath) {
	...
	for (String path:filesToCopy) {
		InputStream stream =  MyLvgAnnotator.class.getClassLoader().getResourceAsStream(prefix+path);
  ...
  public static AnalysisEngineDescription createAnnotatorDescription() throws ResourceInitializationException, MalformedURLException {
    ...
    return AnalysisEngineFactory.createEngineDescription(MyLvgAnnotator.class,
        MyLvgAnnotator.PARAM_USE_CMD_CACHE,
        false,
        MyLvgAnnotator.PARAM_USE_LEMMA_CACHE,
        false,
        MyLvgAnnotator.PARAM_USE_SEGMENTS,
        false,
        MyLvgAnnotator.PARAM_LEMMA_CACHE_FREQUENCY_CUTOFF,
        20,
        MyLvgAnnotator.PARAM_LEMMA_FREQ_CUTOFF,
        20,
        MyLvgAnnotator.PARAM_POST_LEMMAS,
        false,
        MyLvgAnnotator.PARAM_LVGCMDAPI_RESRC_KEY,
        ExternalResourceFactory.createExternalResourceDescription(
        		MyLvgCmdApiResourceImpl.class, url));
	}
