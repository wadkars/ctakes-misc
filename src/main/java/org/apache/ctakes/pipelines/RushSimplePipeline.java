 ...
 *
 */
public final class RushSimplePipeline {
  private RushSimplePipeline() {
   ...
   *           if there is an I/O problem in the reader
   */
  public static String runPipeline(final CollectionReader reader, final AnalysisEngine... engines)
   ...
   // while (reader.hasNext()) {
      ...
      String result = cas.getView("RESULT_VIEW").getDocumentText();
      cas.reset();
    //}
